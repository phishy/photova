import type { OperationType, OperationInput, OperationResult } from './types';
...
export const SUPPORTED_OPERATIONS: OperationType[] = [
  'background-remove',
  'upscale', 
  'unblur',
  'face-restore',
...
async function pollForResult(apiKey: string, predictionId: string, maxAttempts = 120): Promise<{ output: string | string[] }> {
...
export async function executeReplicate(operation: OperationType, input: OperationInput): Promise<OperationResult> {
