    ...
    <header class="fixed top-0 left-0 right-0 z-50 h-14 bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-white/5">
        <div class="h-full px-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <a href="https://github.com/phishy/brighten" target="_blank" class="text-gray-400 hover:text-white transition">
...
<span class="text-purple-400">git</span> clone https://github.com/phishy/brighten.git
...
<span class="text-purple-400">cd</span> packages/brighten-api
